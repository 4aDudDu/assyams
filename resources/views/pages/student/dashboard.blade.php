...
@section('title', 'Dashboard - Pondok As-Syams')
    ...
    <div class="bg-gray-50 min-h-screen pb-12">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16">
            ...
            @if(isset($activeSemester) && $activeSemester)
                <div class="bg-white rounded-lg shadow-lg p-6 mb-8 border-l-4 {{ $paymentStatus == 'success' ? 'border-green-500' : 'border-red-500' }} fade-in-section">
